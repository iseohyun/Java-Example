/*
 * 닫힘 버튼이 눌렸을 때, 프로그램 종료 할 수 있습니다.
 * 
 * 또한, 각각의 이벤트가 발생했을 때, 메시지를 출력합니다.
 * 
 */
...
public class D1_ExitInterface extends Frame implements WindowListener {
    public D1_ExitInterface() {
