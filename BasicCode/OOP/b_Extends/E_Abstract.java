...
/**
 * 
 * 추상클래스는 추상 메서드를 가질 수 있습니다. 또한 인스턴스를 만들 수 없습니다.
 * 
 * 추상클래스를 사용하는 목적은 구조를 잡기 위해서 입니다. (주목적) 계층구조로 작성하고자 할 때, 직접 인스턴스를 작성할 필요는 없지만,
 * 하위 클래스들이 일정한 메서드를 사용하도록 강제할 수 있습니다.
 *
 */
...
public class E_Abstract {
  ...
  public static void main(String[] args) {
    // Abs1 ab = new Abs1(); // 추상 클래스는 인스턴스를 생성할 수 없음.
