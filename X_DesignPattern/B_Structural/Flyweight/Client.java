...
final class FontData {
	...
	@Override
	public int hashCode() {
		return pointSize + effects.hashCode() + fontFace.hashCode() + color.hashCode();	// 낮은 확률로 overflow에러가 있을 수 있습니다. 예시일 뿐, 재설계가 필요한 것은 맞습니다.
		//return pointSize + effects.hashCode() + fontFace.hashCode();	// 다음과 같이 수정했을 때, 다른 점은?
	}
}