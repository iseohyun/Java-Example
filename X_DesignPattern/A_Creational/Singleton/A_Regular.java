...
class viewN{
	...
	class MainPage {
		...
		Button login;
		PageSetting setting;
		MainPage(){setting = new PageSetting();}
	}
	...
	class loginPage{
		...
		Button ForgetPW;
		PageSetting setting;
		loginPage(){setting = new PageSetting();}
	}
	...
	class PremiumPage{
		...
		Button like;
		PageSetting setting;
		PremiumPage(){setting = new PageSetting();}
	}
	
	class PageSetting {
		ViewColor ViewMode;	// Dark, White, Pupple
		MenuPos  MenuBar;	// bottom, top, left, right
		PageSetting(){ViewMode = ViewColor.Dark; MenuBar = MenuPos.top;}
