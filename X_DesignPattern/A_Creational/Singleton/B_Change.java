package Singleton;
enum ViewColor { Dark, White, Pupple }
enum MenuPos { bot, top, left, right }
...
class viewx{
	...
	class MainPage {
		...
		Button login;
		PageSetting setting;
		MainPage(PageSetting init){setting = init;}
	}
	...
	class loginPage{
		...
		Button ForgetPW;
		PageSetting setting;
		loginPage(PageSetting init){setting = init;}
	}
	...
	class PremiumPage{
		...
		Button like;
		PageSetting setting;
		PremiumPage(PageSetting init){setting = init;}
	}
