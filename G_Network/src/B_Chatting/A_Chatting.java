...
public class A_Chatting extends JFrame implements KeyListener, ActionListener{
	...
	public void keyReleased(KeyEvent e) {
		...
		case 10: //Enter
			...
			@SuppressWarnings("static-access") String strtime = (time.get(Calendar.AM_PM)==1?"오후 ":"오전 ") + Integer.toString(time.HOUR) + " : " + Integer.toString(time.MINUTE);
	...
	public void run() {
		while(true) {
			try {
				...
				String strtime = (time.get(Calendar.AM_PM)==1?"오후 ":"오전 ") + Integer.toString(time.HOUR) + " : " + Integer.toString(time.MINUTE);
